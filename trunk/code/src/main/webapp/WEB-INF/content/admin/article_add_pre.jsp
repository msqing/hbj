...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr class="odd" >
    <td colspan="2" align="center"><input type="submit" value="确认添加" class="shortbutton" onMouseOver="this.className='shortbutton_mouseover'" onMouseOut="this.className='shortbutton'"/></td>
  </tr>
  </table></td>
  </tr>
