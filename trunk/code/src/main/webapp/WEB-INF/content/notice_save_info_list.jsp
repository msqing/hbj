  ...
  <div class="main liebiao" id="main">
    <div class="row-fluid">
      <div class="Article" id="example">
        ...
        <form action="saveInfoList.do" id="myForm">
		  <table class="its">
			<tr>
				<th>项目名称</th>
				<th>建设地点</th>
				...
				<s:iterator value="page.getResult()" status="st">
					<tr class="odd">
						<td align="center" title="<s:property value="name" />">
							<s:if test="!timeOut && fileName.length()>0">
								<s:if test="name.length() > 13">
		                            <a href="http://hbj.changning.sh.cn/ManagerBg/Filupld/<s:property value='fileName'/>" style="text-decoration: none;color: black;"><s:property value="name.substring(0,10)" />...</a>
		                        </s:if>
		                        <s:else>
		                            <a href="http://hbj.changning.sh.cn/ManagerBg/Filupld/<s:property value='fileName'/>" style="text-decoration: none;color: black;"><s:property value="name" /></a>
		                        </s:else>
							</s:if>
							<s:else>
								<s:if test="name.length() > 13">
						...
						<td align="center"><s:property value="checkUnit"/></td>
